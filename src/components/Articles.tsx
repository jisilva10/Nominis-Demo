...
export const Articles = () => {
    return (
        <section id="articulos" className="py-24 relative z-10 bg-black/10">
            <div className="container mx-auto px-6">
                <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                    >
                        <h2 className="text-4xl md:text-5xl font-bold font-heading mb-4">Nuestros Artículos</h2>
                        <p className="text-white/80 text-lg">Insights y tendencias del mundo de la comunicación.</p>
                    </motion.div>
                    ...
                    <motion.a
                        ...
                        viewport={{ once: true }}
                        href="#"
                        className="hidden md:flex items-center space-x-2 font-bold hover:opacity-80 transition-opacity"
                    >
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    {articles.map((article, index) => (
                        <motion.article
                            ...
                            className="group bg-white rounded-2xl overflow-hidden text-slate-800 flex flex-col h-full"
                        >
                            ...
                            <div className="p-8 flex-1 flex flex-col">
                                ...
                                <h3 className="text-xl font-bold mb-4 group-hover:text-[#3581bb] transition-colors">
                                    {article.title}
                                </h3>
                ...
                <div className="mt-12 text-center md:hidden">
                    <a href="#" className="inline-flex items-center space-x-2 font-bold hover:opacity-80 transition-opacity border border-white px-6 py-3 rounded-full">
                        <span>VER TODOS LOS ARTÍCULOS</span>
                        <ArrowRight className="w-5 h-5" />
                    </a>
                </div>
